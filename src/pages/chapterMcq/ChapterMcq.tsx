  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] flex flex-col">
      <div className="flex flex-1">
        {/* Main Content */}
        <main className="flex-1 lg:p-8 px-3 py-2 mt-20 lg:mt-10">
          {/* Chapter Card */}
          ...
          <div className="bg-white border rounded-xl p-6">
            ...
            <div className="flex gap-6">
              <div className="flex-1 border rounded-xl flex flex-col items-center justify-center py-8 cursor-pointer hover:shadow">
                <ListAltIcon className="lg:text-4xl text-2xl text-gray-500 mb-2" />
                <div className="lg:text-lg text-[10px] font-medium text-gray-600">MCQs</div>
              </div>
              <div className="flex-1 border rounded-xl flex flex-col items-center justify-center py-8 cursor-pointer hover:shadow">
                <QuestionAnswerIcon className="lg:text-4xl text-2xl text-gray-500 mb-2" />
                <div className="lg:text-lg text-[10px] font-medium text-gray-600">Q/A</div>
              </div>
              <div className="flex-1 border rounded-xl flex flex-col items-center justify-center py-8 cursor-pointer hover:shadow">
                <EditIcon className="lg:text-4xl text2xl text-gray-500 mb-2" />
                <div className="lg:text-lg text-[10px] font-medium text-gray-600">Words</div>
              </div>
            </div>
